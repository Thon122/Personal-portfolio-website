...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // -----------------------------------------------------
  // POINT 1: NAVIGATION SMOOTHNESS
  // CSS `scroll-behavior: smooth` handles the animation,
  // but a plain anchor jump still lands the section edge
  // right under the fixed header. This intercepts the
  // click, does a smooth scroll, and subtracts the header
  // height so the target section is fully visible.
  // -----------------------------------------------------
  navLinks.forEach(link => {
